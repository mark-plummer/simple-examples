...
** Component versions and components that are (issue #504) hidden as they have no page content link:multiple-components/hidden-empty-versions/build/site/component1/v1/index.html[]
