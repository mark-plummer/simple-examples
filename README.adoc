...
** Using the @djencks/asciidoctor-antora-indexer extension with page tags to create 'related pages' functionality link:extensions/index-extension-tags/build/site/index.html[]
