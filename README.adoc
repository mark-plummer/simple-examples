...
** Source map example showing several examples of source_map in antora.yml for different parts of a distributed component link:distributed-components/source-map/build/site/component/1.0/index.html[]