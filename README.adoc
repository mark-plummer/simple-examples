...
** Using the @djencks/asciidoctor-antora-indexer to create index lists and tables of pages selected from the Antora content catalog link:extensions/index-extension/build/site/index.html[]
** WARNING: asciidoctor-plantuml is unmaintained and broken. Using the asciidoctor-plantuml.js extension, demonstrating especially inline/interactive svg link:extensions/plantuml-extension/build/site/index.html[]
