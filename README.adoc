...
** Using the asciidoctor-plantuml.js extension, demonstrating especially inline/interactive svg link:one-components/plantuml/build/site/index.html[]
** Using the asciidoctor-mathjax.js extension for server-side stem rendering link:one-components/mathjax/build/site/index.html[]
