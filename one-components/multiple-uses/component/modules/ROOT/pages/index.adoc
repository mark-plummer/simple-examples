...
If the flows were in different components, linking to an un-stubbed file would transfer you to the component the original file was in, with that component's navigation.